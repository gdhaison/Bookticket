class NotificationBroadcastJob < ApplicationJob
  ...
  def render_counter counter
    ApplicationController.renderer.render(partial: "manager/notifications/counter",
                                          locals: { counter: counter })
  end

  def render_notification notification
    ApplicationController.renderer.render(partial: "manager/notifications/notification",
